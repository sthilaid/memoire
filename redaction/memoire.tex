...
revenus aux États-Unis. Ce profit provient d'une grande diversité de
joueurs, allant de jeunes enfants aux à leurs grands-parents avec une
population féminine presque égale à la population masculine. Il en
résulte donc qu'une grande diversité de jeux et de plate-forme de
jeux se retrouvent sur le marché.
...
essentiellement par les besoins suivant:
...
beaucoup de travail et imposent beaucoup de contraintes au
...
Par contre, les joueurs n'ont pas toujours eu des attentes aussi
élevées envers les jeux auxquels ils jouaient. Il fut une époque ou le
graphisme était très coûteux et donc, c'était principalement la
composante de \textit{gameplay} qui importait.

\todo{Diversité des jeux (genres, plates-formes)}
