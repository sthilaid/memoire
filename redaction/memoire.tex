...
puissance d'abstraction aux programmeurs.
...
de programmation orienté objet et l'intégrer directement au
...
d'abstraction pourrait peut-être s'avérer trop grand. Par contre, s'il
...
nous croyons que le bénéfice résultant est bien supérieur à ce dernier
sur des plateformes performantes. Les techniques de programmations
orientées objets développées nous ont permis de rapidement pouvoir
développer un nouveau jeu en réutilisant plusieurs modules, dont
notamment les modules de rendus graphiques et de résolution de
collisions. 

Si la plateforme sur laquelle un jeu développé est plus limitée,
surtout en ce qui a attrait à la puissance du processeur et aux temps
d'allocations et d'accès mémoires, l'aspect dynamique du langage
Scheme pourrait alors être utilisé comme langage de script afin de
permettre un développement dynamique de prototypes ou de niveaux de
jeu.
