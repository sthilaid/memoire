...
\item \scheme{(or <match1> ...)} : La valeur du paramètre doit
  correspondre à au moins une des clause \scheme{<match>} pour pouvoir
...
dans la figure \ref{OO:genfun-val-dispatch}.
...
\todo{instances doivent venir *apres* les declrations de classes...}
