...
d'observer le coût associé à de telles attentes. Finalement, un test
plus réaliste d'un serveur de \scheme{ping} a été utilisé. Le corps de
ce test pour notre système est illustré dans la figure
...
\begin{table}
  ...
  \begin{tabular}{cccccc}
    ...
    \scheme{!} et \scheme{?} &  6.877 & 1.328 & 2.061 & ND\\
...
\begin{table}
  ...
  \begin{tabular}{cccccc}
    ...
    \scheme{!} et \scheme{?} &  5.2 & 1.0 & 1.6 & ND\\
...
\begin{table}
  ...
  \begin{tabular}{ccc}
    ...
    Nombres d'images par secondes & 29.8 & 83.6\\
