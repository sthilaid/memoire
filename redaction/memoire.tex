...
modification d'attributs et les fonctions de constructions d'instances
peuvent être générées sans problèmes. La plupart contiendront des
indirections pour l'accès aux champs, sauf pour les attributs de
classes qui eux, se retrouvent directement dans les descripteurs de
classes. La figure \ref{OO:obj-struct} donne un exemple concret de
illustrant les structures utilisées. On constate bien que le premier
élément du vecteur correspondant à l'instance créée est aussi un
vecteur qui correspond au descripteur de la classe \scheme{toto}. Le
premier élément de ce descripteur est le nom de la classe, le deuxième
est la liste des super classes par la suite viennent les indexes des
...
(lambda (\#:obj445)
  (vector-ref \#:obj445\\
              (vector-ref (instance-class-descriptor \#:obj445) 3)))
}}
