...
les résultats obtenus face à ces points de comparaison.
...
\begin{table}
  ...
  \hline \hline
  Utilisation du processeur & & 70~\%\\
  Nombres d'images par secondes & & 83.6\\
  Durée minimum de pause du GC & & 0.0033~s\\
  Durée moyenne de pause du GC & & 0.0045~s\\
  Durée maximum de pause du GC & & 0.0096~s\\
  Quantité de mémoire utilisée & & 1.5~Mo\\
  \hline
  \caption{}
  \label{Exp:perf}
\end{table}
...
validation des techniques utilisées pour \textit{Space Invaders} sur un jeu plus
complexe. Ainsi, \textit{Lode Runner} fut développé en utilisant les abstractions de
