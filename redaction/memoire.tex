...
Le contrôle de flot d'exécution dans ce jeu fut expérimental. Dans
...
adressé dans cette nouvelle version. En effet, le contrôle de flot
...
\subsection{Version avec contrôle de flot sous forme de coroutines}
\label{Exp:sp3}

Ainsi, après deux version du jeu, \si possède toujours certains
problèmes dont le contrôle de flot utilisé qui n'est très bien adapté
...
\todo{Utilisation exp de controles de flot => maleabilite de Scheme}

\todo{Utilisation d'un système object a grandement contribué à
  améliorer le code du jeu.}

\todo{GC pas un probleme}
