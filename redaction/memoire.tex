...
retenus. Tout comme les deux techniques précédentes, les ramasses
miettes générationnels nécessitent l'arrêt du programme durant
l'opération récupération, qui peu, dans le pire cas, s'effectuer sur
toute la mémoire.
...
les ramasses miettes incrémentaux ou temps
réels~\cite{INCR_BAKER}. Ceux-ci peuvent utiliser un algorithme de
marquage à trois couleurs de la mémoire afin d'effectuer partiellement
le travail de récupération et de poursuivre l'application dans le but
de continuer ultérieurement. Il en résulte donc que les pauses dues à
la récupération peuvent être contrôlées et être de temps constant.

\todo{enumerer les techniques utilisees}

Malgré le fait que ces techniques permettent d'assurer une borne
supérieure sur le temps de récupération mémoire, elle ajoutent un
délais sur chaque accès ou sur chaque écritures mémoire. Donc, dans le
cadre de jeux vidéo ces coûts supplémentaires peuvent être
indésirables. Toutefois, l'utilisation de ces systèmes de gestion de
mémoire automatique permettent d'éviter d'avoir de trop lentes pauses
dues à la récupération mémoire.
...
performances et ce, de manière continue. Ainsi, une attention
particulière devra être apportée sur l'utilisation de la mémoire pour
ne pas avoir de trop grandes pauses de récupération.
...
Le langage \clisp~\cite{CLISP} possède un système orienté objet,
...
Plusieurs système objets sont déjà disponible pour des système
