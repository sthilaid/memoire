...
et de fenêtrage. Le système de rendu utilisé est nul autre que
...
dimensionnel. Ainsi, la librairie de lecture et de chargement d'images
s'occupe de lire des images en format textuel \textit{ppm}, qui est
l'un des format les plus simple pour d'écrire une image
\textit{bitmap}. Le système s'attend à lire des images sous forme de
fontes, \ie des images contenant plusieurs sous-images.

\todo{Premier jet dans le but de trouver des problèmes potitiels}

\todo{Simulation a evenements discrets}
