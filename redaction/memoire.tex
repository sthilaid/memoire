...
Une interfaces aux fonctions étrangères (\textit{Foreign Function
  Interface} ou FFI) est rendue disponible par le système
Gambit-C. D'une part, cette dernière permet l'importation et
l'utilisation de fonctions C ou C++ présentent dans de librairies. La
figure \ref{}
...
en Scheme de manière à ce qu'elles soient utilisée à partir de code C
ou C++.
...
chargement d'image a dû être écrite. Plutôt que d'utiliser une
...
la librairie SDL~\cite{SDL} a été utilisée comme système de gestion
d'entrées/sorties et de fenêtrage. Le système de rendu utilisé est
\textit{OpenGL}~\cite{OpenGL} afin de pouvoir profiter d'une bonne
portabilité et de permettre facilement d'ultérieurement utiliser les
travaux effectués pour faire des jeux vidéo produisant un rendu tri
dimensionnel. L'utilisation des interfaces aux fonctions étrangères
(\textit{Foreign Function Interface}) du système Gambit-C ont fait en
sorte que la tâche d'accès et d'utilisation de ces librairies fut
triviale.
