...
autre système objet disponible pour Gambit-C. Celui-ci offre plus de
...
\item \scheme{(update! <instance> <class-name> <slot-name> <fun>)} :
  ...
  comme nouvelle valeur de cet attribut.
...
utilisateurs de modifier le comportement du système selon leurs
besoins.
...
polymorphisme du système objet en plus du petit langage de définition
