...
\section{Conclusion}
\todo{Langages de haut niveau permettrait d'aider au développement de jeu en
  apportant une grande expressivité et puissance d'abstraction.}
\todo{petites réduction du temps de développement == grandes économies budgétaires}
\todo{Bonnes abstraction == réutilisation}
