...
du système objets. Ainsi, nous avons opté pour un compromis entre la
...
module. L'implantation du support intermodulaire du système objets n'a
...
principales du système objets. Les systèmes objets
...
\begin{table}
  ...
  \caption{Comparaison de performances relative au système le plus
    rapide (1.0) pour chaque opérations du système objets.}
  \label{OO:bench-rel}
\end{table}
...
orientée objet. Ce système objets permet la déclaration de classes avec
