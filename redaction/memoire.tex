...
Scheme. Finalement, un patron spécial permettant d'effectuer des
...
\begin{table}
  ...
  \begin{tabular}{cccccc}
    ...
    Envoi et réception simple de messages & 1.798 & 2.374 & 6.992 &    ND\\
    Réception de message avec filtrage    & 5.098 & ND    & 4.877 & 2.575\\
    \hline
  \end{tabular}
...
\begin{table}
  ...
  \begin{tabular}{cccccc}
    ...
    Envoi et réception simple de messages & 1.0 & 1.3 & 3.9 & ND \\
    Réception de message avec filtrage    & 2.0 & ND  & 1.9 & 1.0 \\
    \hline
  \end{tabular}
  \caption{Comparaison de performances relative au système le plus
...
\noindent
où les états sont normalement décrits par des symboles. Les actions
peuvent être n'importe quelles expression Scheme. Aussi, lors de la
...
Ainsi, les macros et les fonctions d'ordre supérieures de Scheme ont
